...
{
    [Table("tContinuousAllowableVoltageDistortion")]
    public class ContinuousAllowableVoltageDistortion : BasePickListEntity
    {
        public ContinuousAllowableVoltageDistortion()
        {
