...
{
    [Table("tMomentaryAllowableVoltageDistortion")]
    public class MomentaryAllowableVoltageDistortion : BasePickListEntity
    {
        public MomentaryAllowableVoltageDistortion()
        {
